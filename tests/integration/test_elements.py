...
'''
    expected_html = (
        '<fieldset class="texts" id="texts" data-id="texts">'
        '<legend>texts'
...
'''
    expected_html = (
        ...
        '<a class="btn-delete" data-target="#parent:texts:text">Delete</a>'
        '<a data-comment-name="texts:text:_comment" class="btn-comment">'
        'Comment</a>'
        '<textarea name="texts:text:_value" id="texts:text" '
...
'''
    expected_html = (
        ...
        'id="parent:texts:list__text:1:text">'
        '<label>text</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text:1:text">Delete</a>'
    ...
    str_to_html = [
        ...
        ('texts:list__text:10:text',
         ...
         'id="parent:texts:list__text:10:text">'
         '<label>text</label>'
         '<a class="btn-delete btn-list" '
         'data-target="#parent:texts:list__text:10:text">Delete</a>'
...
'''
    ...
    expected_html = (
        ...
        '</legend>'
        '<div class="list-container">'
        '<a class="btn btn-add-ajax btn-list" data-id="texts:list__text:0:text">'
        'New text</a>'
        '<fieldset class="text texts:list__text:0:text" '
        'id="texts:list__text:0:text" data-id="texts:list__text:0:text">'
        '<legend>text'
        '<a data-comment-name="texts:list__text:0:text:_comment" '
        'class="btn-comment">Comment</a>'
        '<a class="btn-delete btn-list" '
        ...
        'id="parent:texts:list__text:0:text:subtext">'
        '<label>subtext</label>'
        ...
        '</div>'
        '</fieldset>'
        '<a class="btn btn-add-ajax btn-list" data-id="texts:list__text:1:text">'
        'New text</a>'
        '</div>'
        '</fieldset>'
    )
    ...
    str_to_html = [
        ('texts',
         ...
         '</fieldset>'
         '<a class="btn btn-add-ajax btn-list" '
         'data-id="texts:list__text:1:text">'
         'New text</a>'
         '</div>'
         '</fieldset>'
        ),
        ('texts:list__text:1:text',
         '<fieldset class="text texts:list__text:1:text" '
         'id="texts:list__text:1:text" data-id="texts:list__text:1:text">'
         '<legend>text'
         '<a data-comment-name="texts:list__text:1:text:_comment" '
         'class="btn-comment">Comment</a>'
         '<a class="btn-delete btn-list" '
         ...
         'id="parent:texts:list__text:1:text:subtext">'
         '<label>subtext</label>'
         ...
         '</fieldset>'
         '<a class="btn btn-add-ajax btn-list" '
         'data-id="texts:list__text:2:text">'
         'New text</a>'
        )
    ]
...
choice_str_to_html = [
    ...
    ('texts:text1',
     '<div data-id="texts:text1" id="parent:texts:text1">'
     '<label>text1</label>'
     '<select class="btn btn-add-ajax hidden">'
     '<option>New text1/text2</option>'
     '<option value="texts:text1">text1</option>'
     '<option value="texts:text2">text2</option>'
     '</select>'
     '<a class="btn-delete" data-target="#parent:texts:text1">Delete</a>'
...
choicelist_str_to_html = [
    ('texts',
     ...
     '</legend>'
     '<div class="list-container">'
     '<select class="btn btn-add-ajax btn-list">'
     '<option>New text1/text2</option>'
    ...
    ('texts:list__text1_text2:0:text1',
     ...
     'id="parent:texts:list__text1_text2:0:text1">'
     '<label>text1</label>'
     '<a class="btn-delete btn-list" '
     'data-target="#parent:texts:list__text1_text2:0:text1">Delete</a>'
    ...
    ('texts:list__text1_text2:10:text1',
     ...
     'id="parent:texts:list__text1_text2:10:text1">'
     '<label>text1</label>'
     '<a class="btn-delete btn-list" '
     'data-target="#parent:texts:list__text1_text2:10:text1">Delete</a>'
...
'''
    expected_html = (
        ...
        'id="parent:texts:list__text1_text2:1:text2">'
        '<label>text2</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text1_text2:1:text2">Delete</a>'
        ...
        'id="parent:texts:list__text1_text2:2:text1">'
        '<label>text1</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text1_text2:2:text1">Delete</a>'
...
'''
    expected_html = (
        ...
        '<fieldset class="text1 texts:list__text1:0:text1" '
        'id="texts:list__text1:0:text1" data-id="texts:list__text1:0:text1">'
        '<legend>text1'
        ...
        'id="parent:texts:list__text1:0:text1:list__text2:0:text2">'
        '<label>text2</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text1:0:text1:list__text2:0:text2"'
        '>Delete</a>'
        ...
        'id="parent:texts:list__text1:0:text1:list__text2:1:text2">'
        '<label>text2</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text1:0:text1:list__text2:1:text2"'
        '>Delete</a>'
        ...
        '<fieldset class="text1 texts:list__text1:1:text1" '
        'id="texts:list__text1:1:text1" data-id="texts:list__text1:1:text1">'
        '<legend>text1'
        ...
        '</legend>'
        '<div class="list-container">'
        '<a class="btn btn-add-ajax btn-list" data-id="texts:list__text1:1:text1:'
        'list__text2:0:text2">New text2</a>'
        '<div data-id="texts:list__text1:1:text1:list__text2:0:text2" '
        'id="parent:texts:list__text1:1:text1:list__text2:0:text2">'
        '<label>text2</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text1:1:text1:list__text2:0:text2"'
        '>Delete</a>'
    ...
    str_to_html = [
        ...
        ('texts:list__text1:0:text1:list__text2:3:text2',
         ...
         'id="parent:texts:list__text1:0:text1:list__text2:3:text2">'
         '<label>text2</label>'
         '<a class="btn-delete btn-list" '
         'data-target="#parent:texts:list__text1:0:text1:list__text2:3:text2"'
         '>Delete</a>'
...
'''
    expected_html = (
        ...
        '</div>'
        '<div class="list-container">'
        '<a class="btn btn-add-ajax btn-list" data-id="texts:list__text1:0:text1">'
        'New text1</a>'
        '<div data-id="texts:list__text1:0:text1" '
        'id="parent:texts:list__text1:0:text1">'
        '<label>text1</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text1:0:text1">Delete</a>'
        '<a data-comment-name="texts:list__text1:0:text1:_comment" '
        'class="btn-comment">Comment</a>'
        ...
        'id="parent:texts:list__text1:1:text1">'
        '<label>text1</label>'
        '<a class="btn-delete btn-list" '
        'data-target="#parent:texts:list__text1:1:text1">Delete</a>'
        '<a data-comment-name="texts:list__text1:1:text1:_comment" '
        'class="btn-comment">Comment</a>'
        ...
        'My text 2</textarea>'
        '</div>'
        '<a class="btn btn-add-ajax btn-list" data-id="texts:list__text1:2:text1">'
        'New text1</a>'
        '</div>'
        '</fieldset>'
    )
