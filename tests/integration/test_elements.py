...
'''
    expected_html = (
        ...
        '<label>text</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text:1:text\')"></span>'
        '<a class="btn-delete btn-list" '
    ...
    str_to_html = [
        ...
        ('texts:list__text:10:text',
         ...
         '<label>text</label>'
         '<span class="btn-external-editor" '
         'ng-click="externalEditor(\'texts:list__text:10:text\')"></span>'
         '<a class="btn-delete btn-list" '
...
'''
    ...
    expected_html = (
        ...
        '<label>subtext</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text:0:text:subtext\')"></span>'
    ...
    str_to_html = [
        ...
        ('texts:list__text:1:text',
         ...
         '<label>subtext</label>'
         '<span class="btn-external-editor" '
         'ng-click="externalEditor(\'texts:list__text:1:text:subtext\')"></span>'
...
choice_str_to_html = [
    ...
    ('texts:text1',
     ...
     '<label>text1</label>'
     '<span class="btn-external-editor" '
     'ng-click="externalEditor(\'texts:text1\')"></span>'
...
choicelist_str_to_html = [
    ...
    ('texts:list__text1_text2:0:text1',
     ...
     '<label>text1</label>'
     '<span class="btn-external-editor" '
     'ng-click="externalEditor(\'texts:list__text1_text2:0:text1\')"></span>'
     '<a class="btn-delete btn-list" '
    ...
    ('texts:list__text1_text2:10:text1',
     ...
     '<label>text1</label>'
     '<span class="btn-external-editor" '
     'ng-click="externalEditor(\'texts:list__text1_text2:10:text1\')"></span>'
     '<a class="btn-delete btn-list" '
...
'''
    expected_html = (
        ...
        '<label>text2</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text1_text2:1:text2\')"></span>'
        '<a class="btn-delete btn-list" '
        ...
        '<label>text1</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text1_text2:2:text1\')"></span>'
        '<a class="btn-delete btn-list" '
...
'''
    expected_html = (
        ...
        '<label>text2</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text1:0:text1:list__text2:0:text2\')"></span>'
        '<a class="btn-delete btn-list" '
        ...
        '<label>text2</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text1:0:text1:list__text2:1:text2\')"></span>'
        '<a class="btn-delete btn-list" '
        ...
        '<label>text2</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text1:1:text1:list__text2:0:text2\')"></span>'
        '<a class="btn-delete btn-list" '
    ...
    str_to_html = [
        ...
        ('texts:list__text1:0:text1:list__text2:3:text2',
         ...
         '<label>text2</label>'
         '<span class="btn-external-editor" '
         'ng-click="externalEditor(\'texts:list__text1:0:text1:list__text2:3:text2\')"></span>'
         '<a class="btn-delete btn-list" '
...
'''
    expected_html = (
        ...
        '<label>text1</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text1:0:text1\')"></span>'
        '<a class="btn-delete btn-list" '
        'data-target="#texts:list__text1:0:text1" title="Delete"></a>'
        '<a data-comment-name="texts:list__text1:0:text1:_comment" '
        'class="btn-comment" title="Add comment"></a>'
        ...
        '<label>text1</label>'
        '<span class="btn-external-editor" '
        'ng-click="externalEditor(\'texts:list__text1:1:text1\')"></span>'
        '<a class="btn-delete btn-list" '
        'data-target="#texts:list__text1:1:text1" title="Delete"></a>'
        '<a data-comment-name="texts:list__text1:1:text1:_comment" '
        'class="btn-comment" title="Add comment"></a>'
