...
'''
    expected_html = (
        ...
        'Comment</a>'
        '<textarea name="texts:text:_value" id="texts:text" class="texts:text">'
...
'''
    expected_html = (
        ...
        'Comment</a>'
        '<textarea name="texts:text:_value" id="texts:text" '
        'class="texts:text">Hello world</textarea>'
        '</div>'
        '</fieldset>'
    )
...
'''
    expected_html = (
        ...
        'id="texts:list__text:1:text" class="texts:list__text">'
        'Tag 2</textarea>'
        '</div>'
        '<a class="btn btn-add-ajax-list" '
    ...
    str_to_html = [
        ('texts',
         ...
         'class="btn-comment">Comment</a>'
         '<textarea name="texts:list__text:0:text:_value" '
         'id="texts:list__text:0:text" class="texts:list__text"></textarea>'
         '</div>'
         '<a class="btn btn-add-ajax-list" '
         'data-id="texts:list__text:1:text">New text</a>'
         '</div>'
        ...
        ('texts:list__text:10:text',
         ...
         'id="texts:list__text:10:text" class="texts:list__text"></textarea>'
         '</div>'
         '<a class="btn btn-add-ajax-list" '
...
'''
    ...
    expected_html = (
        ...
        'class="texts:list__text:0:text:subtext"></textarea>'
        '</div>'
        '</fieldset>'
    ...
    str_to_html = [
        ...
        ('texts:list__text:1:text',
         ...
         'class="texts:list__text:1:text:subtext"></textarea>'
         '</div>'
         '</fieldset>'
...
'''
    expected_html = (
        ...
        'id="texts:text1" class="texts:text1">Tag 1</textarea>'
        '</div>'
        '</fieldset>'
    )
...
choicelist_str_to_html = [
    ...
    ('texts:list__text1_text2:0:text1',
     ...
     'class="texts:list__text1_text2"></textarea>'
     '</div>'
     '<select class="btn btn-add-ajax-choice-list">'
     '<option>New text1/text2</option>'
...
'''
    expected_html = (
        ...
        '<textarea name="texts:list__text1_text2:0:text1:_value" '
        'id="texts:list__text1_text2:0:text1" '
        'class="texts:list__text1_text2">Tag 1</textarea>'
        '</div>'
        '<select class="btn btn-add-ajax-choice-list">'
        '<option>New text1/text2</option>'
        '<option value="texts:list__text1_text2:1:text1">text1</option>'
        ...
        'class="texts:list__text1_text2">Tag 2</textarea>'
        '</div>'
        '<select class="btn btn-add-ajax-choice-list">'
        '<option>New text1/text2</option>'
        ...
        'class="texts:list__text1_text2">Tag 3</textarea>'
        '</div>'
        '<select class="btn btn-add-ajax-choice-list">'
        '<option>New text1/text2</option>'
...
'''
    expected_html = (
        ...
        'class="texts:list__text1:0:text1:list__text2">text2-1</textarea>'
        '</div>'
        '<a class="btn btn-add-ajax-list" '
        ...
        'class="texts:list__text1:0:text1:list__text2">text2-2</textarea>'
        '</div>'
        '<a class="btn btn-add-ajax-list" '
        ...
        'class="texts:list__text1:1:text1:list__text2">text2-3</textarea>'
        '</div>'
        '<a class="btn btn-add-ajax-list" '
    ...
    str_to_html = [
        ...
        ('texts:list__text1:0:text1',
         ...
         'data-id="texts:list__text1:0:text1">Add text1</a>'
         '<a class="btn-delete-fieldset">Delete</a>'
         '<a data-comment-name="texts:list__text1:0:text1:_comment" '
         'class="btn-comment">Comment</a>'
         '</legend>'
         ...
         'class="texts:list__text1:0:text1:list__text2"></textarea>'
         '</div>'
         '<a class="btn btn-add-ajax-list" '
        ...
        ('texts:list__text1:0:text1:list__text2:3:text2',
         ...
         'class="texts:list__text1:0:text1:list__text2">'
         '</textarea>'
         '</div>'
         '<a class="btn btn-add-ajax-list" '
...
'''
    expected_html = (
        ...
        'id="texts:list__text1:0:text1" class="texts:list__text1">'
        'My text 1</textarea>'
        '</div>'
        '<a class="btn btn-add-ajax-list" data-id="texts:list__text1:1:text1">'
        'New text1</a>'
        ...
        'id="texts:list__text1:1:text1" class="texts:list__text1">'
        'My text 2</textarea>'
        '</div>'
